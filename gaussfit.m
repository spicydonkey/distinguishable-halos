function [fit_param,fit_xy]=gaussfit(x,y,param0,VERBOSE)
% Gaussian fit to the correlation plots and return fit params as estimate(amp,mu,c),SE
% 
% INPUT
% x: x-data
% y: y-data
% params0: 1x4 array of initial conditions to fitting algorithm - [amp_0, mu_0, sigma_0, c_0]
%
% OUTPUT
...
fitobject=fitnlm(x,y,...
    'y~amp*exp(-1*(x1-mu)^2/(2*sigma^2))+c',...
    param0,...
    'CoefficientNames',{'amp','mu','sigma','c'},'Options',fo);
