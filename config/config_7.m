...
%% FILES
configs.files.path='\\AMPLPC29\He BEC Archive\EXPERIMENT-DATA\xstate_mom_corr\90deg_raman_beams\7_vlownum\d';
...
configs.load.id=1:455;         % file id numbers to use for analysis
...
configs.halo.boost{2}=[0.0475,0.0015,-0.003];
...
configs.corr{1}.lim=0.2*repmat([0,1],[3,1]);
