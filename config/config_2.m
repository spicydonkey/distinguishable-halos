...
configs.bec.pos{1}=[1.6524,-3.3e-3,3.7e-3];   % approx condensate locations (z,x,y)
configs.bec.Rmax{1}=6e-3;      % max condensate sph radius
configs.bec.dR_tail{1}=2;     % BEC tail radial frac diff
configs.bec.pos{2}=[1.6446,-3.3e-3,0.0e-3];
...
configs.halo.boost{2}=[0.048,0.005,-0.015];    %[0.045,0.0,-0.015];
