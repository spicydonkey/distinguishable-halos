...
%% FILES
configs.files.path='C:\Users\David\Documents\hebec\halo_analysis\data\dist_halo\5_separated_higherN_short\d';
...
configs.bec.dR_tail{1}=1.25;     % BEC tail radial frac diff
configs.bec.pos{2}=[2.00467e+01,-9.8e-3,1.1e-3];
configs.bec.Rmax{2}=4e-3;
configs.bec.dR_tail{2}=1.25;
...
configs.corr{1}.lim=0.25*repmat([-1,1],[3,1]);
configs.corr{1}.nBin=9*ones(1,3);
% 
