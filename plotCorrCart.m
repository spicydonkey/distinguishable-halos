function [HFIG]=plotCorrCart(FIGNUM,CORRDATA,INDEX)
...
ind_zero=round((CORRDATA.nBin{INDEX}+1)/2); % zero-cent'd bin index for sampling 3D-g2
...
zlabel(['$G^{(2)}_{BB(',num2str(CORRDATA.type{INDEX}.comp),')}$']);
axis tight;
shading interp;
